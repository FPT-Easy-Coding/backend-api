...
//                    ),
     ...
     * Verifies the code.
     *
     * @param verificationRequest the VerificationRequest object containing the code to be verified
     * @return an instance of ResponseEntity containing the result of the verification
     */
    @PostMapping("/verify")
